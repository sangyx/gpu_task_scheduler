...
A simple Python lib that helps schedule deep learning tasks on available GPUs using `nvidia-smi`. It supports custom GPU selection and concurrency limits per GPU.
