...
class GPUTaskScheduler:
    ...
    def __init__(self, wait_interval=10, allowed_gpu_ids=None, max_tasks_per_gpu=1):
        ...
        self.gpu_task_counts = defaultdict(int)  # Tracks how many tasks are running on each GPU
...
if __name__ == "__main__":
    ...
    allowed_gpus = [0, 1, 2]  # Specify which GPU IDs are allowed to be used
    max_tasks = 1  # Maximum number of concurrent tasks per GPU
    scheduler = GPUTaskScheduler(allowed_gpu_ids=allowed_gpus, max_tasks_per_gpu=max_tasks)
